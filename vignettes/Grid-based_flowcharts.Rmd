...
- `insert()` places the exclusion box into the list at the right vertical position;
  `move()` shifts it into the right-hand column.
...
flowchart(
  ...
  connect(stringr::regex("^ex"), "groups3", type = "side",
          ...
          side = "right",
          end_side = "right",
          side_fan_in_route = "outside",
          side_fan_in_offset = ex_gap)
