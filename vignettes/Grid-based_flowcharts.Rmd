...
```{r math_expressions, fig.width=6, fig.height=4}
grid.newpage()
###############
# Expressions #
###############
# Font style
spreadHorizontal(
  boxGrob(expression(bold("Bold text")), y = 0.8),
  boxGrob(expression(italic("Italics text")), y = 0.8),
  boxGrob(expression(paste("Mixed: ", italic("Italics"), " and ", bold("bold"))), y = 0.8)
)

# Math
spreadHorizontal(
  boxGrob(expression(paste("y = ", beta[0], " + ", beta[1], X[1], " + ", beta[2], X[2]^2)), y = 0.5),
  boxGrob(expression(sum(n, i == 1, x) %subset% " \u211D"), y = 0.5),
  boxGrob(expression(paste(beta, gamma, Gamma)), y = 0.5)
)
