...
Key to having a good descriptive statistics is to be able to output it into a table. I usually rely on `htmlTable` for all my table requirements as it has a nice set of
...
Even though p-values are discouraged in the Table 1, they are [not uncommon](https://doi.org/10.1177/1741826711421688). I have therefore added basic statistics consisting of tests that default to Fisher's exact test for proportions and Wilcoxon rank sum test for continuous values. 
