...
#'  format. The plots are transitionPlot and forestplot2. Apart from those 
#'  you will find a few handy functions for formatting p-values, generating
#'  the basic stats for your table 1, etc.
#' 
#' @name Gmisc
#' @docType package
